            ...
            <section id="checkout" className='container'>
                ...
                <form>
                    <div className='checkout-col'>
                        ...
                        <label htmlFor="billing-address2">Suite / Unit</label>
                        ...
                        <select name="billing-state" onChange={this.FormChangeHandler}>
                    ...
                    <div className='checkout-col '>
                        ...
                        <div>
                            <div className='stacked'>
                                ...
                                <input type="tel" maxLength="7" name="shippingPhone" value={this.state.shippingPhone} onChange={this.FormChangeHandler} required />
                            </div>
                            <div className='stacked'>
                                <label htmlFor="shippingEmail">Email Address</label>
                                <input type="email" maxLength="40" name="shippingEmail" value={this.state.shippingEmail} onChange={this.FormChangeHandler} required />
                            </div>
                        </div>
                    </div>
                </form>
